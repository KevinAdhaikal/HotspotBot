module.exports = {
    async execute(bot, msg, button, userData, valButton) {
        bot.editMessageText(`Limit Uptime saat ini = ${userData.addUser.limitUptime ? userData.addUser.limitUptime : "TIdak ada"}\n\nSilahkan isi Limit Uptime nya\nContoh: 1d 00:00:00`, {
        ...
        userData.userInput = "hotspotAddUser=limits=limitUptime"
    }
}